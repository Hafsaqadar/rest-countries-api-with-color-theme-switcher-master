...
<div className="p-8">
  <button
    onClick={() => navigate("/")}
    className="cursor-pointer font-normal  mt-10 text-light-text text-lg inline-flex gap-2 items-center justify-center bg-white dark:bg-dark-element dark:text-white hover:bg-light-bg hover:dark:bg-dark-bg py-2 px-9 rounded-md shadow-md">
    <FaArrowLeft />
    Back
  </button>
...
src={country.flags.png} alt="Country Flag" /> 
    ...
    <div className="flex-1  lg:ml-20">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8 mt-11 lg:w-450">
        ...
        {/* Right Column */}
        <div className='font-light lg:mr-14'>
          <p className="text-lg mb-4">
          ...
          <div className='flex flex-wrap gap-2 '>
            ...
            <strong className='text-xl'>Border Countries:</strong>
                ...
                <button
           className="text-light-text text-sm bg-white dark:bg-dark-element dark:text-white px-3 py-1 mr-4  rounded-sm shadow-sm cursor-pointer hover:bg-light-bg hover:dark:bg-dark-bg"
